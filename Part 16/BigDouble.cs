...
namespace BreakInfinity
{
    ...
    public struct BigDouble : IFormattable, IComparable, IComparable<BigDouble>, IEquatable<BigDouble>
    {
        ...
        public static BigDouble Mod(BigDouble initial, BigDouble divider)
        {
            double newMantissa = initial.mantissa / divider.mantissa;
            long newExponent = initial.exponent - divider.exponent;
            BigDouble Quotient = new BigDouble(newMantissa, newExponent);
            Quotient = Floor(Quotient);

            return new BigDouble(initial.Subtract(Quotient * divider));
        }
    ...
    public static class Prefixes
    {
        ...
        {
            "", "K", "M", "B", "Tr", "Qu", "Qi", "Sx", "Sp", "Oc", "No"
        };

        public static List<string> allPrefixes = new List<string>
            {
